...
class WC_Gateway_Lemonway_Sofort extends WC_Gateway_Lemonway {
	public function __construct() {
		...
		$this->method_description = __('Secured payment solutions for Internet marketplaces, eCommerce, and crowdfunding. Payment API. BackOffice management. Compliance. Regulatory reporting.',LEMONWAY_SOFORT_TEXT_DOMAIN);
