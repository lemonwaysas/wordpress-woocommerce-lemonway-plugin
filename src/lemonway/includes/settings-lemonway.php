...
return array(
	...
	WC_Gateway_Lemonway::DIRECTKIT_URL => array(
			...
			'type'        => 'text',
			'description' => 'JSON only ! E.g: https://ws.lemonway.fr/mb/xxx/yyy/directkitjson/service.asmx/',
			'default'     => '',
			'desc_tip'    => false,
			'placeholder' => ''
	),	
	...
	WC_Gateway_Lemonway::DIRECTKIT_URL_TEST => array(
			...
			'type'        => 'text',
			'description' => 'JSON only ! E.g: https://ws.lemonway.fr/mb/xxx/dev/directkitjson/service.asmx/',
			'default'     => '',
			'desc_tip'    => false,
			'placeholder' => ''
	),
